...
SECRET_KEY = 'django-insecure-1=!tjor0m)4+%ph3-d4v_$45kw#cmjlijy#b^87v&=2-6=1ls!'
...
EMAIL_USE_TLS = True  # Use True for TLS or False if using SSL
EMAIL_USE_SSL = False  # Use True for SSL if your server requires it
